            ...
            <div class="flex justify-center w-full h-full my-auto xl:gap-14 lg:justify-normal md:gap-5 draggable">
                <div class="flex items-center justify-center w-full lg:p-12">
                    <div class="flex items-center xl:p-10">
                        {{-- formulaire de saisie email et password --}}
                        <form class="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl">
                            ...
                            <div class="flex flex-row justify-between mb-8">
                                <label class="relative inline-flex items-center mr-3 cursor-pointer select-none">
                                    ...
                                    <div
                                        class="w-5 h-5 bg-white border-2 rounded-sm border-grey-500 peer peer-checked:border-0 peer-checked:bg-cyan-600">
                                        <img class=""
                                ...
                                <a href="javascript:void(0)" class="mr-4 text-sm font-medium text-cyan-600">Forget
                                    password?</a>
                            </div>
                            <button
