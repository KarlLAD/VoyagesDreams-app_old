        <nav class="bg-black  px-10 py-5"></nav>
        <nav class="flex justify-between px-20 py-10 items-center bg-cyan-600">

            <h1 class="text-xl text-gray-800 font-bold"></h1>
            ...
            <div class="flex items-center">
                ...
                <ul class="flex items-center lg:mx-auto lg:w-auto lg:space-x-6">
